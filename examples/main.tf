module "services_and_slos" {
  ...
  # Notification channels: Alt 1 - List of notification channels ids
  fallback_notification_channels = ["projects/my-gcp-project/notificationChannels/123456"]

  # Notification channels: Alt 2 - Use friendly names for notification channels
